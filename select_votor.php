  ...
  <a class="navbar-brand" href="#">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="blood-donee-home.php">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="test-blood-search.php">Seacrh for Blood</a>
              </li>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="blood-donee-profile.php">Profile</a></li>
                                    ...
                                    echo "<tr>";
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <input type="hidden" name="search" value="<?= $row['email']; ?>">
