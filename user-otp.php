        ...
        <div class="row g-0">
          ...
          <div class="col-lg-7  px-5 pt-5">
            ...
            <form  action="user-otp.php" method="POST" autocomplete="off">
              <div class="form-row">
                <div class="">
                  <input class="form-control p-3 my-3"  type="number" name="otp" placeholder="Enter verification code" required>
                </div>
              </div>
              <div class="form-row">
              <div class="form-group">
                  <input class="form-control button btn1 my-3" type="submit" name="check" value="Submit">
              </div>
              </div>
