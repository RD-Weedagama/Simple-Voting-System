...
.container .row {
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="upcoming_campaigns.php">Upcoming Elections</a>
            </li>
            <li>
              <div>
                <a class="btn btn-light" href="login-user.php" role="button">Sign in</a>
              </div>
            </li>
          </ul>
        </div>
  ...
  <div class="mid">
      ...
      <div class="btn">
          <a class="simple" href="login-user.php">Vote Now</a>
      </div>
  </div>
